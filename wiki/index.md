...
Part of the multilingual [plurality-llm-wiki](https://github.com/nishio/plurality-llm-wiki) wiki森. This wiki is autonomous — pages are not required to be translations of, or aligned with, the ja-side wiki ([plurality-llm-wiki-ja](https://github.com/nishio/plurality-llm-wiki-ja)). Cross-language correspondences (and gaps) are tracked in the parent's `correspondences.yaml`.

## Concepts

### Core
- [Plurality](concepts/Plurality.md) — the umbrella concept, technology for collaboration across social difference
- [Connected Society](concepts/Connected-Society.md) — Danielle Allen's normative ideal
- [Digital Democracy](concepts/Digital-Democracy.md) — Taiwan as the canonical instance
- [The Lost Dao](concepts/The-Lost-Dao.md) — what the internet could have been (Licklider, Engelbart, Nelson)
- [Tridemism](concepts/Tridemism.md) — Sun Yat-Sen's Three Principles as a root of Taiwan's Digital Democracy
- [Sunflower Movement](concepts/Sunflower-Movement.md) — the 2014 pivot

### Section 4 — Freedom (rights / OS layer)
- [Identity and Personhood](concepts/Identity-and-Personhood.md)
- [Association and Plural Publics](concepts/Association-and-Plural-Publics.md)
- [Commerce and Trust](concepts/Commerce-and-Trust.md)
- [Property and Contract](concepts/Property-and-Contract.md)
- [Data Coalitions](concepts/Data-Coalitions.md)
- [Access](concepts/Access.md)

### Section 5 — Democracy (collaboration tech)
- [Collaborative Technology and Democracy](concepts/Collaborative-Technology-and-Democracy.md) — the depth/breadth spectrum
- [Post-Symbolic Communication](concepts/Post-Symbolic-Communication.md)
- [Immersive Shared Reality](concepts/Immersive-Shared-Reality.md)
- [Creative Collaborations](concepts/Creative-Collaborations.md)
- [Augmented Deliberation](concepts/Augmented-Deliberation.md)
- [Adaptive Administration](concepts/Adaptive-Administration.md)
- [Plural Voting](concepts/Plural-Voting.md)
- [Quadratic Voting](concepts/Quadratic-Voting.md)
- [Liquid Democracy](concepts/Liquid-Democracy.md)
- [Social Markets](concepts/Social-Markets.md)
- [Quadratic Funding](concepts/Quadratic-Funding.md)
- [Plural Management Protocol](concepts/Plural-Management-Protocol.md)
- [Generative Foundation Models](concepts/Generative-Foundation-Models.md)
...
*(empty — cross-language analyses live in the parent wiki, not here)*
