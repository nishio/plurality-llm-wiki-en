...
The Anno passage above was inferred from [[civic-ai-manifesto]] but is now **upstream-confirmed**. PR #1043 (nishio, derived from upstream Issue #1007, merged 2024-12-21) is the actual commit that added the Anno paragraph and footnotes (AnnoManifestSlide, AnnoTTTCReports, AnnoGitHub, AIAnno, Anno2024) to `5-4-augmented-deliberation.md`. The PR-level audit lives at [[pluralitybook-upstream-2024-2026]] and the entity page is [[Takahiro-Anno]]. The book's wording specifically mentions the **15-day GitHub window** (232 issues raised, 104 proposals, 85 adopted) and the November 2024 use of TttC for Tokyo's 2050 plan (10,000+ opinions by December 13) — both points absent from earlier post-book sources.

### 2026-05-27: Synthetic Party (Det Syntetiske Parti, Denmark, 2022) added in PR #939

From [[pluralitybook-upstream-2024-2026]] (PR #939 ComputerLars, merged 2024-06-12): the upstream EN manuscript now names **The Synthetic Party** (Det Syntetiske Parti) — founded 2022 in Denmark, "officially the world's first political party driven by artificial intelligence" — as a worked example of GFM-mediated collective representation. The party was created by the Computer Lars artist group (Asker Bryld Staunæs / Benjamin Asger Krog Møller) in collaboration with tech-hub MindFuture; it fine-tunes a GFM on >200 Danish micro-parties that fail the electoral threshold, **algorithmically integrating the 15-20% abstention rate** as its target constituency. Notice that this is a different design pattern from [[Takahiro-Anno|Anno]]'s campaign (where AI augments a human candidate) — the Synthetic Party tries to make the *party itself* a GFM.
