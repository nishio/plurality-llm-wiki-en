...
### 2026-05-28: Buterin's "Soulbound" and "Three Transitions" as the web3-side sibling

From [[vitalik-soulbound]] (Jan 2022) and [[vitalik-three-transitions]] (June 2023): [[Vitalik-Buterin]]'s web3-side framing of identity *predates* the Plurality book and develops in parallel. The Soulbound essay introduces non-transferable NFTs as a primitive against "wealth signaling everywhere" — the seed of the *Decentralized Society* (DeSoc) paper co-authored with [[Glen-Weyl]] and Puja Ohlhaver (May 2022). The Three Transitions essay (2023) makes a deeper move: "your name is not you, your name is one of many attributes of you" — explicitly rejecting ENS-as-identity in favour of a *keystore contract* anchor that holds a bundle of (spending pubkey, encryption pubkey, stealth meta-address, …). This is the cryptographic-stack cousin of the book's "identity as bundle of verifiable credentials + DIDs + social-graph position." The two frames are largely compatible but the web3 framing places more weight on *cryptographic primitives* (ZK-SNARKs, KZG commitments) where the book places more weight on *institutional design* (trust frameworks, group-level claims).

### 2026-05-28: Per-relationship fine-tuning as a relational identity primitive

From [[civic-ai-with-us-vitalik]] (March 2026): Buterin proposes "ideally every pair of people that talks to each other should have a model fine-tuned to their relationship" — and [[civic-ai-gentle-bridge]] (Tenzin Yangtso) reads this back through the Tibetan-Buddhist ideal of unique-relational-presence. This is a *third* identity primitive emerging in 2026, distinct from both verifiable-credentials-bundle (the book) and keystore-contract (Buterin 2023): identity-as-the-relationship-itself, where the AI model is the medium that carries the relationship's history and norms.
